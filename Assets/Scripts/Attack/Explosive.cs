...
namespace MRD
{
    public class Explosive : Attack
    {
        ...
        void Update()
        {
            ...
            transform.localScale = new Vector3(EaseOutCubic(animationTimer/animationTime) * ExplosiveInfo.Radius, EaseOutCubic(animationTimer/animationTime) * ExplosiveInfo.Radius, 1);
