    ...
    public class SoSaHeeChecker : IYakuConditionChecker
    {
        ...
        public bool CheckCondition(YakuHolderInfo holder)
        {
            ...
            return holder.MentsuInfos.Count(
                       x => x is KoutsuInfo or KantsuInfo && x.Hais[0].Spec.HaiType == HaiType.Kaze) == 3 && // 몸통 3개
                   holder.MentsuInfos.Count(x => x is ToitsuInfo && x.Hais[0].Spec.HaiType == HaiType.Kaze) ==
                   1; //머리 하나
        }
    }
}
